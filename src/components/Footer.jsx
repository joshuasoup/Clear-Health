...
const Footer = () => {
  return (
    <footer className="relative text-w pt-10 pb-8 w-full h-auto md:px-20 px-8">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 min-w-fit mr-12">
            <a href="https://clearhealth.care/" className="flex items-center ">
              <Image
                src={Logo}
                height={40}
                width={40}
                ...
                className="mr-5"
              />
              <span className="self-center lg:text-5xl text-3xl font-semibold whitespace-nowrap text-white">
                Clear Health
              </span>
            </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li>
                  <a href="https://clerk.com/" className="hover:underline">
                    Clerk
                  </a>
                </li>
              </ul>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            © 2024{" "}
            <a href="https://clearhealth.care/" className="hover:underline">
              ClearHealth™
            </a>
            . All Rights Reserved.
          </span>
